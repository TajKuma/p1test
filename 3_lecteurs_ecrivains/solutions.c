...
int nb_lecteurs = 0; //nbr lecteurs critique
int nb_ecrivains = 0; //nbr écrivains écrivant (ici 0|1)
int attente_ecrivains = 0; //file écrivains
...
void *ecrivain(void *arg) {
    ...
    for(int k = 0; k < total_ecritures; k++) {
        ...
        //critique
        for(int i = 0; i < 10000; i++);//ecriture simulee
        base_de_donnees++;
